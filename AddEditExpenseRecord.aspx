<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="AddEditExpenseRecord.aspx.cs" Inherits="WebPoultryFarmManager.AddExpenseRecord" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <ContentTemplate>
            <table class="tblAddEntry" cellpadding="4" cellspacing="4">
                <tr>
                    <td></td>
                    <td>
                        <asp:Label ID="lblMainTitle" runat="server" CssClass="maintitle" Text="Add Expense Record" style="padding-top:5px; padding-bottom:10px;"></asp:Label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtEntryDate" runat="server" ReadOnly="true" class="txtReadOnly" onclick="showcalendar();" style="width:160px;"></asp:TextBox>
    ...
    <script type="text/javascript">
        ...
        function on_post_backcall() {
            ...
            else if (isSaved != "" && isSaved == "updated")
