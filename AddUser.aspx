<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="WebPoultryFarmManager.AddUser" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="tblAddUser" cellpadding="4" cellspacing="4">
        <tr>
            <td></td>
            <td>
                <asp:Label ID="lblMainTitle" runat="server" CssClass="maintitle" Text="Add User" style="padding-top:5px; padding-bottom:10px;"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
